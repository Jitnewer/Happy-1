...
export class Event {
  ...
  static createSampleEvents2 (pId = 0) {
    const images = [require('../assets/eventPic/arnhem-event.jpg'), require('../assets/eventPic/rotterdam-event.webp'), require('../assets/images/restaurant-nederland.png'), require('../assets/images/cafe-nederland.png')]
